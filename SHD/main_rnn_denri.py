...
#create the DH-SRNN with single layer
class rnn_test(nn.Module):
    def __init__(self,):
        super(rnn_test, self).__init__()
        n = 64
        #the DH-SRNN layer
        self.rnn_1 = spike_rnn_test_denri_wotanh_R(700,n,tau_ninitializer = 'uniform',low_n = 2,high_n=6,vth= 1,dt = 1,branch = 8,device=device)
        #readout layer
