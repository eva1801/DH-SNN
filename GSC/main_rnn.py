...
class RNN_test(nn.Module):
    def __init__(self,):
        ...
        self.rnn_1 = spike_rnn_test_denri_wotanh_R(40*3,n,vth= 1,dt = 1,branch = 1,device=device,bias=is_bias)
        #readout layer
        self.dense_2 = readout_integrator_test(n,12,dt = 1,device=device,bias=is_bias)
...
def train(epochs,criterion,optimizer,scheduler=None):
    acc_list = []
    best_acc = 0
    path = 'model/rnn_denri_1layer_neruon200_branch1_initzero_MG' 
