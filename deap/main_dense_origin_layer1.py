...
class Dense_test(nn.Module):
    def __init__(self,):
        ...
        self.dense_1 = spike_dense_test_origin(32,n,vth= 1,dt = 1,device=device,bias=is_bias)
...
def train(epochs,criterion,optimizer,scheduler=None):
    ...
    path = 'model/'  # .pth'
    name = 'dense_origin_neuron200_MG_bs200_nl2h6_final_initzeros_seed0_epoch100_renew_label3_layer1'
