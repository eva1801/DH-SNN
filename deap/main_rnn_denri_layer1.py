...
class RNN_test(nn.Module):
    def __init__(self,):
        ...
        n = 100
        #DH-SRNN layer
        self.rnn_1 = spike_rnn_test_denri_wotanh_R(32,n,tau_ninitializer = 'uniform',low_n = 0,high_n = 4,vth= 1,dt = 1,branch =4,device=device,bias=is_bias)
        #readout layer
...
def train(epochs,criterion,optimizer,scheduler=None):
    ...
    path = 'model/'  # .pth'
    name = 'rnn_denri_branch8_neuron100_MG_bs200_nl0h4_final_initzeros_seed0_epoch100_label2_arousal'
